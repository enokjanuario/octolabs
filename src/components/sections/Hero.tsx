    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 py-32">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            Seu projeto travado?{' '}
            <span className="text-gradient-animated">Nós destravamos.</span>
          </motion.h1>
          ...
          >
            Transformamos sua ideia em software funcionando em <strong className="text-text-primary">até 30 dias</strong>.
            Web, mobile, integrações — com código limpo e suporte contínuo.
          </motion.p>
